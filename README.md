...
## Environments
- Preview: https://main--sausaxen-aia--aemysites.aem.page/
- Live: https://main--sausaxen-aia--aemysites.aem.live/
- Block Library: https://main--sausaxen-aia--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `sausaxen-aia` directory in your favorite IDE and start coding :)
